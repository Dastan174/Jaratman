...
def _parse_cmdline_options(cmdline_options_str: str, path: str) -> List[str]:
    ...
    Also substitutes the revision script token_session with the actual filename of
    the revision script.

    If the revision script token_session doesn't occur in the options string, it is
