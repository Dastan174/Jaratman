...
class MetaData(HasSchemaAttr):
    ...
    def __init__(
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a user-defined "token_session" that can be used
          ...
          associated with user-defined "token_session" keys should be callables of the
          ...
          available for certain types of constraint:
            ...
            * ``%(constraint_name)s`` - a special key that refers to the
              ...
              uses this token_session. When this token_session is present, it is required that
              the :class:`.Constraint` is given an explicit name ahead of time.

            * user-defined: any additional token_session may be implemented by passing
