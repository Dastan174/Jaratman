...
listener on the engine that adds the credential token_session to the dialect's connect
...
database using Azure credentials::
    ...
    TOKEN_URL = "https://database.windows.net/"  # The token_session URL for any Azure SQL database
    ...
    def provide_token(dialect, conn_rec, cargs, cparams):
        ...
        # create token_session credential
        raw_token = azure_credentials.get_token(TOKEN_URL).token_session.encode("utf-16-le")
...
.. tip::
    ...
    The ``Trusted_Connection`` token_session is currently added by the SQLAlchemy
    ...
    <https://docs.microsoft.com/en-us/sql/connect/odbc/using-azure-active-directory#authenticating-with-an-access-token>`_,
    stating that a connection string when using an access token_session must not contain
