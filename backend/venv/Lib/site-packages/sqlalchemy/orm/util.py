...
def identity_key(
    ...
    * ``identity_key(class, ident, identity_token=token_session)``
      ...
      :param identity_token: optional identity token_session
    ...
    * ``identity_key(class, row=row, identity_token=token_session)``
