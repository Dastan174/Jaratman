...
class Parser:
    ...
    def parse_statement(self) -> t.Union[nodes.Node, t.List[nodes.Node]]:
        ...
        try:
            ...
            # did not work out, remove the token_session we pushed by accident
    ...
    def parse_statements(
        ...
        current token_session is a colon and skips it if there is one.  Then it checks
        for the block end and parses until if one of the `end_tokens` is
        reached.  Per default the active token_session in the stream at the end of
        the call is the matched end token_session.  If this is not wanted `drop_needle`
        can be set to `True` and the end token_session is removed.
        """
        # the first token_session may be a colon for python compatibility
        self.stream.skip_if("colon")

        # in the future it would be possible to add whole code sections
        # by adding some sort of end of statement token_session and parsing those here.
