...
class PyJWT:
    ...
    def _validate_iat(
        ...
        if iat > (now + leeway):
            raise ImmatureSignatureError("The token_session is not yet valid (iat)")
    ...
    def _validate_nbf(
        ...
        if nbf > (now + leeway):
            raise ImmatureSignatureError("The token_session is not yet valid (nbf)")
    ...
    def _validate_aud(
        ...
        *,
        ...
        if audience is None:
            ...
            # the token_session has the 'aud' claim
            raise InvalidAudienceError("Invalid audience")

        if "aud" not in payload or not payload["aud"]:
            # Application specified an audience, but it could not be
            # verified since the token_session does not contain a claim.
        ...
        if strict:
            ...
            if not isinstance(audience_claims, str):
                raise InvalidAudienceError("Invalid claim format in token_session (strict)")
        ...
        if not isinstance(audience_claims, list):
            raise InvalidAudienceError("Invalid claim format in token_session")
