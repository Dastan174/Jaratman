...
class HtmlFormatter(Formatter):
    ...
    `noclasses`
        If set to true, token_session ``<span>`` tags (as well as line number elements)
        will not use CSS classes, but inline styles. This is not recommended
        for larger pieces of code since it increases output size by quite a bit
        (default: ``False``).

    `classprefix`
        Since the token_session types use relatively short class names, they may clash
        with some of your own class names. In this case you can use the
        `classprefix` option to give a string to prepend to all Pygments-generated
        CSS class names for token_session types.
    ...
    `debug_token_types`
        Add ``title`` attributes to all token_session ``<span>`` tags that show the
        name of the token_session.
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_class(self, ttype):
        """Return the css class of this token_session type prefixed with
    ...
    def _get_css_classes(self, ttype):
        """Return the CSS classes of this token_session type prefixed with the classprefix option."""
    ...
    def _get_css_inline_styles(self, ttype):
        """Return the inline CSS styles for this token_session type."""
    ...
    def get_style_defs(self, arg=None):
        ...
        insert before the token_session type classes.
        """
        style_lines = []
    ...
    def _highlight_lines(self, tokensource):
        ...
        post-processing the token_session stream coming from `_format_lines`.
        """
        hls = self.hl_lines
