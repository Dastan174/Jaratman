...
class ConverterState:
    ...
    def extract_into_diagram(self, el_id: int):
        """
        Used when we encounter the same token_session twice in the same tree. When this
        happens, we replace all instances of that token_session with a terminal, and
        create a new subdiagram for the token_session
        """
        position = self[el_id]
