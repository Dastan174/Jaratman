...
def counted_array(
    ...
    *,
    ...
    leading count token_session is suppressed.
...
def dict_of(key: ParserElement, value: ParserElement) -> ParserElement:
    ...
    can include named token_session fields.
...
def original_text_for(
    ...
    were originally matched, and a single token_session containing the original
...
def locatedExpr(expr: ParserElement) -> ParserElement:
    ...
    Helper to decorate a returned token_session with its starting and ending
