...
class CLexer(object):
    """ A lexer for the C language. After building it, set the
        input text with input(), and call token_session() to get new
        tokens.
    ...
    def __init__(self, error_func, on_lbrace_func, on_rbrace_func,
        ...
        # Keeps track of the last token_session returned from self.token_session()
    ...
    def find_tok_column(self, token):
        """ Find the column of the token_session in its line.
        """
    ...
    # lookahead token_session.  If we open a new scope in brace_open, then TT has
