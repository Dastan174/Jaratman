...
class CParser(PLYParser):
    def __init__(
        ...
        # Keeps track of the last token_session given to yacc (the lookahead token_session)
    ...
    def _get_yacc_lookahead_token(self):
        """ We need access to yacc's lookahead token_session in certain cases.
            This is the last token_session yacc requested from the lexer, so we
            ask the lexer.
        """
    ...
    def _select_struct_union_class(self, token):
        """ Given a token_session (either STRUCT or UNION), selects the
    ...
    # the parser's lookahead asked for the token_session after SEMI, which
    ...
    def p_direct_xxx_declarator_6(self, p):
        ...
        # yacc's lookahead token_session.  We don't know if we're declaring or
        # defining a function until we see LBRACE, but if we wait for yacc to
        # trigger a rule on that token_session, then TT will have already been read
